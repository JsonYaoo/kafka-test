...
public class QuickStartProducer {
    ...
    public static void main(String[] args) {
        ...
        /*1.1. 连接kafka集群的服务列表，如果有多个，使用"逗号"进行分隔*/
        properties.put(ProducerConfig.BOOTSTRAP_SERVERS_CONFIG, "192.168.1.111:9200");
        ...
        ProducerRecord<String, String> record = new ProducerRecord<>("topic-quickstart", JSON.toJSONString(user));
